...
public class CopilotChatRootAction implements RootAction {
    ...
    public HttpResponse doLogout() {
        ...
        chatService.invalidateSession(user);
    ...
    /**
     * \ud83d\udcac Handles an incoming chat message and streams the AI response via Server-Sent
     * Events.
     *
     * <p>Flow:
     *
     ...
     *       <ul>
     *         <li>\ud83d\udcdd {@code delta} \u2014 partial text chunks as they arrive (streamed
     *             token-by-token)
     *         <li>\ud83e\udde0 {@code reasoning} \u2014 optional thinking steps from reasoning
     *             models
    ...
    /**
     * \ud83d\udc64 Returns the currently logged-in Jenkins user. Throws an {@link
     * IllegalStateException} if called outside a request context (e.g. background threads), acting
     * as a safety guard.
     */
